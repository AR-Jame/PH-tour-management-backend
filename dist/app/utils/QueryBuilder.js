...
const tour_constant_1 = require("../module/tour/tour.constant");
class QueryBuilder {
    ...
    filter() {
        ...
        for (const field of tour_constant_1.excludeFields) { // to delete all other value from the query that doesn't need for find
            delete filter[field];
        }
