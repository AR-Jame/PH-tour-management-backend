...
const deleteImageFromCloudinary = (url) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new AppError_1.default(401, "Cloudinary image deletion filed.", error.message);
    }
});
...
const uploadBufferToCloudinary = (buffer, fileName) => {
    try {
        ...
        console.log(error);
        throw new AppError_1.default(500, `Error during upload the invoice file ${error.message}`);
    }
};
