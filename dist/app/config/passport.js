...
passport_1.default.use(new passport_local_1.Strategy({
    ...
    try {
        ...
        const isPasswordMatch = yield bcryptjs_1.default.compare(password, isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.password);
        if (!isPasswordMatch) {
...
passport_1.default.use(new passport_google_oauth20_1.Strategy({
    ...
    try {
        ...
        if (user && user.isActive !== user_interface_1.IsActive.ACTIVE) {
