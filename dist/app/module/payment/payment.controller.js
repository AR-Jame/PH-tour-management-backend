...
const successPayment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result.success) {
        res.redirect(`${env_1.envVars.SSL.SSL_SUCCESS_FRONTEND_URL}?transactionId=${query === null || query === void 0 ? void 0 : query.transactionId}&message=${result === null || result === void 0 ? void 0 : result.message}&amount=${query === null || query === void 0 ? void 0 : query.amount}&status=${query === null || query === void 0 ? void 0 : query.status}`);
    }
}));
...
const getInvoiceUrl = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const paymentId = req.params.paymentId;
    const result = yield payment_services_1.paymentServices.getInvoiceUrl(paymentId);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 201,
